        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 md:grid-cols-3">
          {classes.map((level) => (
            <Link
              ...
              className="rounded-xl border border-[var(--line)] bg-white px-5 py-6 text-center font-display text-xl text-ink shadow-sm transition hover:border-cyan hover:bg-sky/40"
            >
              {level}
            </Link>
          ))}
