    ...
    <div className="min-h-[70vh] bg-mist/40">
      <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 max-w-2xl text-clay">
          Pupils check published results by class. Subject teachers send scores to
          the class teacher, who ranks the class and releases results to pupils.
        </p>

        <div className="mt-10 grid gap-5 md:grid-cols-3">
          <Link
            href="/portal/student"
            className="rounded-2xl border border-[var(--line)] bg-navy p-6 text-paper shadow-[var(--shadow)] transition hover:-translate-y-1"
          >
          ...
          <Link
            href="/portal/teacher"
            className="rounded-2xl border border-[var(--line)] bg-white p-6 shadow-[var(--shadow)] transition hover:-translate-y-1"
          >
            ...
            <p className="mt-2 text-sm text-clay">
              Enter your subject results for a class, or open your class portal if
          ...
          >
            ...
            <p className="mt-2 text-sm text-clay">
              See all pupils, assign each teacher to a class, and issue passwords.
            </p>
          </Link>
        </div>
